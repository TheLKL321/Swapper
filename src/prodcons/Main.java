...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        one.add(1);
        threads.add(new Thread(new Consument(one, 5)));
        for (int i = 0; i < 5; i++){
            products.add(1);
        }
        ...
        two.add(2);
        threads.add(new Thread(new Consument(two, 7)));
        for (int i = 0; i < 7; i++){
            products.add(2);
        }
        ...
        three.add(3);
        three.add(4);
        threads.add(new Thread(new Consument(three, 3)));
        for (int i = 0; i < 3; i++){
        ...
        four.add(2);
        four.add(3);
        threads.add(new Thread(new Consument(four, 4)));
        for (int i = 0; i < 4; i++){
